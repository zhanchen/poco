...
Compare compressed file sizes against the original posterior draws.
Expected pattern: GMM-based methods are usually much smaller than KDE
because they store only mixture parameters rather than all data points.

```{r footprint, fig.width=8, fig.height=4}
...
## Compression runtime benchmark

Benchmark compression on the same synthetic posterior matrix for each
backend and visualize runtime.

```{r benchmark-compression, fig.width=8, fig.height=4}
